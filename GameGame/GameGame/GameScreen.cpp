...
{
	font->Initialize(graphics->GetD3D()->GetDevice(), "../Debug/data/fontdata.txt", L"../Debug/data/font.dds");
	...
	Cursor->Initialize(graphics, L"../Debug/data/target.png", 512, 512);
	Cursor->SetOrigin(0.5f, 0.5f);
	Cursor->SetScale(0.125f);

	Player->Initialize(graphics, L"../Debug/data/ball.png", 256, 256);
